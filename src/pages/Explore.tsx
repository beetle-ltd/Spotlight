...
export default function Explore() {
  ...
  return (
    <div>
      ...
      <div className="bg-gray-200 flex flex-col items-center justify-center gap-y-10 py-10 min-h-[300px]">
        <h1 className="flex items-center gap-x-2 text-3xl font-semibold">
          Find products and brands you love
          <FaHeart />
        </h1>
        <div className="flex items-center relative border border-gray-500 p-3 sm:p-4 w-[50%] mx-auto rounded-full text-gray-500">
