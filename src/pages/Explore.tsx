...
export default function Explore() {
  ...
  return (
    <div>
      ...
      <div className="relative z-50 flex flex-col items-center justify-center gap-y-10 md:gap-y-20 py-5 md:py-10 h-[250px] md:min-h-[350px] bg-[url('/src/assets/explore-header.png')] bg-cover bg-white/30 backdrop-filter backdrop-blur-md ">
